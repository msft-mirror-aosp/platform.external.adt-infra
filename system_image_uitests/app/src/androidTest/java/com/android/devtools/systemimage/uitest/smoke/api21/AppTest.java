...
import com.android.devtools.systemimage.uitest.utils.api21.AppTestUtils;
...
public class AppTest {
    ...
    public void setHomePageInBrowser() throws Exception {
        ...
        AppTestUtils.setHomePage(device, "Other", "http://" + homepage);
        device.pressHome();
        ...
        device.pressHome();
        AppLauncher.launch(instrumentation, appName);
        AppTestUtils.setHomePage(device, "Default page");
    }
}
