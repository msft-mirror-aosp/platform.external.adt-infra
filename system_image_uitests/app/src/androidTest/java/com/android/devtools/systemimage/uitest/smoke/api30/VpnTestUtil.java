...
public class VpnTestUtil {
    ...
    private static final String ALT_DEVICE_CONNECTED_TEXT = "This device is connected to TestVPN";
    ...
    public static boolean verifyVpnStatus_v2(final UiDevice device) throws Exception {
        ...
        boolean isTrue = new Wait(TimeUnit.MILLISECONDS.convert(10L, TimeUnit.SECONDS)).until(() -> {
            ...
            return device.hasObject(By.text(NETWORK_MONITORED_TEXT)) ||
                    ...
                    device.hasObject(By.text(ALT_DEVICE_CONNECTED_TEXT));
        });
        device.pressHome();
        return isTrue;
    }
