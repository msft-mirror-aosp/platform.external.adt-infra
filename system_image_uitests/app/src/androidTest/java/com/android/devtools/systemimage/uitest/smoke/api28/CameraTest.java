...
import com.android.devtools.systemimage.uitest.utils.api28.CameraTestUtils;
...
public class CameraTest {
    ...
    public void testPhotoCapture() throws Exception {
        ...
        boolean photoTestSuccess = CameraTestUtils.useCamera(instrumentation, "Camera");
    ...
    public void testVideoCapture() throws Exception {
        ...
        boolean videoTestSuccess = CameraTestUtils.useCamera(instrumentation, "Video");
