...
import com.android.devtools.systemimage.uitest.utils.api27.PlayStoreTestUtils;
import com.android.devtools.systemimage.uitest.utils.api27.PlayStoreUtil;
...
public class PlayStoreTest {
    ...
    private final boolean hasGooglePlay = testFramework.isGoogleApiAndPlayImage();
    ...
    public void testAppInstallation() throws Exception {
        ...
        if (hasGooglePlay) {
            ...
            if (playStoreInstalled) {
                PlayStoreUtil.loginGooglePlay(instrumentation);
                PlayStoreTestUtils.selectApplication(instrumentation, application);
