...
import com.android.devtools.systemimage.uitest.utils.api27.ApiDemosInstaller;
import com.android.devtools.systemimage.uitest.utils.api27.ApiDemosTestUtils;
import com.android.devtools.systemimage.uitest.utils.api27.AppLauncher;
import com.android.devtools.systemimage.uitest.utils.api27.PackageInstallationUtil;
import com.android.devtools.systemimage.uitest.utils.api27.SettingsUtil;
import com.android.devtools.systemimage.uitest.utils.api27.Wait;
...
public class ApiDemosTest {
    ...
    public void testPasswordQuality() throws Exception {
        ...
        Assert.assertTrue(isAPIDemoInstalled);
        ...
        ApiDemosTestUtils.setPasswordCriteria("Minimum length", "6", device);

        // Set minimum letters to 1.
        ApiDemosTestUtils.setPasswordCriteria("Minimum letters", "1", device);

        // Set minimum numerics to 1.
        ApiDemosTestUtils.setPasswordCriteria("Minimum numeric", "1", device);

        // Set minimum lower case letters to 1.
        ApiDemosTestUtils.setPasswordCriteria("Minimum lower case", "1", device);

        // Set minimum upper case letters  to 1.
        ApiDemosTestUtils.setPasswordCriteria("Minimum upper case", "1", device);

        // Set minimum special symbols to 1.
        ApiDemosTestUtils.setPasswordCriteria("Minimum symbols", "1", device);

        // Set minimum non-letter to 1.
        ApiDemosTestUtils.setPasswordCriteria("Minimum non-letter", "1", device);

        Assert.assertTrue(SettingsUtil.openItem(instrumentation, "Security & location"));
        ...
        ApiDemosTestUtils.verifyPasswordQuality(device, "NEXT");
    }
