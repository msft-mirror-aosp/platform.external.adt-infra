...
import com.android.devtools.systemimage.uitest.utils.api23.AppManager;
import com.android.devtools.systemimage.uitest.utils.api23.DeveloperOptionsManager;
...
import com.android.devtools.systemimage.uitest.utils.api23.SettingsTestUtils;
...
public class SettingsTest {
    ...
    public void enableSetDateAndSetTime() throws Exception {
        final String container = Res.ANDROID_LIST_RES;
    ...
    public void testCameraAppDisabled() throws Exception {
        ...
        if (isAPIDemoInstalled) {
            ...
            SettingsTestUtils.findObjectInScrollable(new UiSelector().text("Device administrators")).click();
