...
package com.android.devtools.systemimage.uitest.utils.api28;
...
public class GoogleAppUtil {
    ...
    public static void loginGoogleApp(Instrumentation instrumentation) throws Exception {
        ...
        UiObject forgotEmailLink = device.findObject(new UiSelector().text("Forgot email?"));
        ...
        UiObject forgotPasswordLink = device.findObject(new UiSelector().text("Forgot password?"));
