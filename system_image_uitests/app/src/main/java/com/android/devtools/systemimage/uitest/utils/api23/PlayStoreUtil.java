...
package com.android.devtools.systemimage.uitest.utils.api23;
...
public class PlayStoreUtil {
    ...
    public static boolean installApplication(Instrumentation instrumentation) throws Exception {
        ...
        boolean isInstallable = new Wait(TimeUnit.MILLISECONDS.convert(10L,
    ...
    public static boolean uninstallApplication(Instrumentation instrumentation) throws Exception {
        ...
        boolean isUninstallable = new Wait(TimeUnit.MILLISECONDS.convert(10L,
                TimeUnit.SECONDS)).until(new Wait.ExpectedCondition() {
            @Override
            public boolean isTrue() throws UiObjectNotFoundException {
                return device.findObject(new UiSelector()
