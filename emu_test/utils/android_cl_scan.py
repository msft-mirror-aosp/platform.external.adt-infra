...
def generate_git_information(poller):
  ...
  elif 'emulator_2.6_linux_poller' in poller or 'emulator_2.6_windows_poller' in poller:
    return 'aosp-emu-2.6-release', 'sdk_tools_linux'
  elif 'emulator_2.6_mac_poller' in poller:
    return 'aosp-emu-2.6-release', 'sdk_tools_mac'
  else:
