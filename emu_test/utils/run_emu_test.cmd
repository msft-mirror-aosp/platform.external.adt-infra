...
prebuilts\python\windows-x86\python.exe external\adt-infra\pytest\test_embedded\run_tests.py --verbose --build_dir out\prebuilt_cached\builds --logdir %SESSION_DIR%\testlogs --build_target %BUILD_TARGET_NAME%
if errorlevel 1 (
