...
APP_VULKANCAPSVIEWER_APK = _DATA_DIR / "vulkancapsviewer_4.11_arm.apk"
...
PREBUILT_VULKANCAPSVIEWER_APK = _PREBUILT_DIR / "vulkancapsviewer/vulkancapsviewer/vulkancapsviewer_4.11_arm.apk"
