        ...
        <html>
            <head>
                ...
                <style>
                    ...
                    .mdc-typography--headline1 { margin-bottom: 16px; }
                    .mdc-typography--headline2 { margin-bottom: 16px; }
                    .mdc-typography--headline3 { margin-bottom: 16px; }
                    .mdc-typography--body1 { margin-bottom: 16px; }
                    ...
                    .mdc-list { padding: 0; }
                    .mdc-list-item { height: auto; padding: 16px; pointer-events:none }
            ...
            <xsl:if test="@errors > 0 or @failures > 0">
                <div class="mdc-card__actions">
                    <button class="mdc-button mdc-card__action mdc-card__action--button"
                        ...
                        <span class="mdc-button__label">View Failures</span>
                    </button>
                </div>
            </xsl:if>
        </div>
        <div
            id="suite-{generate-id()}" style="display: none;">
            <ul class="mdc-list mdc-list--two-line">
                <xsl:apply-templates select="testcase">
                    <xsl:with-param name="parent-type" select="'failure'" />
                </xsl:apply-templates>
            </ul>
        </div>
        <div
            ...
            <ul class="mdc-list mdc-list--two-line">
                <xsl:apply-templates select="testcase">
                    <xsl:with-param name="parent-type" select="'skipped'" />
                </xsl:apply-templates>
            </ul>
        </div>
    </xsl:template>
