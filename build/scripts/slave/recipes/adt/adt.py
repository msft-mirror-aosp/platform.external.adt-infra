...
def GenTests(api):
    ...
    yield (
            ...
            props({
                ...
                'buildnumber': '1090',
                'file_list': 'gs://android-build-emu-sysimage/builds/git_oc-emu-dev-linux-sdk_gphone_x86-sdk_addon/4695513/c79ac27430405771fe8249079eb3be15e8944f27ad07f68aea3b2974e29be7c0/sdk-repo-linux-system-images-4695513.zip',
                'got_revision': '4696395',
                'logs_dir': '/home/user/buildbot/external/adt-infra/build/masters/master.client.adt/slave_logs/',
                'mastername': 'client.adt',
                'prev_build': '4696278',
